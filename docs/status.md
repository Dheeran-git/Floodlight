...
- [ ] Dashboard shell renders with dark theme
- [ ] Map loads centered on Bengaluru
- [ ] Navigation works between routes
- [ ] Zustand stores created for incidents/resources/shelters
- [ ] At least one TanStack Query hook fetches data from backend
...
- [ ] Seed data script runs and populates DB
- [ ] Seed data uses realistic Bengaluru coordinates
- [ ] `GET /shelters` returns seed data
- [ ] `GET /resources` returns seed data
